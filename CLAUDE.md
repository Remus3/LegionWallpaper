...
Naming convention: `LW-*` (e.g. `LW-Supervisor`). Registered: `LW-Wallpaper` (desktop deck rotator, 2026-07-18) and `LW-WeeklyHygiene` (Sunday 04:17, 2026-08-02). `LW-GeminiAudit` is retired. Full list + registration commands live in `docs/OPERATIONS.md`.
